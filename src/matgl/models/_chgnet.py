    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            tensor_handling (bool): whether to handle tensor reallocation due to mismatches
                during tensor preallocation. The projected effect on compute efficiency is
                small. The reallocation happens before graph creation and only triggers if
                the buffer from the preallocation is not large enough (RuntimeError).
